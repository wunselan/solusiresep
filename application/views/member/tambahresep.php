      ...
      <div class="container">
        <div class="col-md-4 ml-auto mr-auto">
          <div class="card card-login card-plain">
            <form class="form" method="post" action="<?php echo base_url('resep/insertResep');?>" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="input-group no-border input-lg">
                  <input type="text" class="form-control" id="nama_resep" name="nama_resep" placeholder="Masukkan Nama Resep" required />
                </div>
                <div class="input-group no-border input-lg">
                  <input type="number" class="form-control" id="durasi" name="durasi" placeholder="Masukkan Lama Durasi Memasak (Menit)" required/>
                </div>
                <div class="input-group no-border input-lg">
                  <input type="number" class="form-control" id="porsi" name="porsi" placeholder="Masukkan Jumlah Porsi Makanan" required />
                </div>
            ...
            <div class="input-group">
              ...
              <div class="custom-file">
                <input accept="image/*" type="file" id="resep_foto" name="resep_foto" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" required>
