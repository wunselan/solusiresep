    ...
    <div class="page-header clear-filter page-header-small" filter-color="orange">
      ...
      <div class="content">
          <a href="<?php echo base_url('/user/profile/'.$profile[0]['username'].'/'.$profile[0]['id_user'])?>">
            <div class="social-description" style="color:white;">
    ...
    <div class="section">
      <div class="container">
        <div class="button-container">
          ...
          if(isset($_SESSION['id_user'])){
            if ($_SESSION['id_user']=== $profile[0]['id_user']){?>
              <form action="<?php echo base_url('/teman/follower/'.$profile[0]['username'].'/'.$profile[0]['id_user'])?>" method="post">
      ...
      <div class="row" style="margin-top:40px;">
        <div class="card">
          <div class="card-header col-md-12 text-center">
            <h3 style="margin-bottom: 0px; margin-top:20px;">Diikuti</h3>
          </div>
          <div class="card-body">
            <?php foreach($follow as $f){ ?>
            <div class="row" style=" padding:30px;">
              <div class="text-center img-follow">
              ...
              <div class="text-right tombol-lihat">
